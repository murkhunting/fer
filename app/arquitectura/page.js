...
export default function Arquitectura() {
  return (
    <div>
      <h2 className="fixed text-white h-[48px] px-6 rounded-md bg-[rgba(247, 247, 247, 0)]/10 shadow-[0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[20px] top-5 right-20 z-30 flex items-center justify-center">
        ARQUITECTURA
      </h2>
