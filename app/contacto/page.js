      ...
      <div className="w-screen h-screen flex flex-col justify-center items-center">
        <div className="h-[100vh] sticky pt-10 pb-50 top-0 flex flex-col justify-center items-center text-white">
          ...
          <div className="flex fle-row items-center justify-center gap-10 mt-10">
            <div className="bg-[rgba(247, 247, 247, 0)]/10 shadow-[0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[20px] rounded-md p-4 cursor-pointer text-white text-5xl hover:text-zinc-300">
              <PiInstagramLogoLight />
            </div>
            <div className="bg-[rgba(247, 247, 247, 0)]/10 shadow-[0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[20px] rounded-md p-4 cursor-pointer text-white text-5xl hover:text-zinc-300">
              <PiYoutubeLogoLight />
