...
export default function ProjectRow({ projectName }) {
  ...
  return (
    <div className="w-full mt-3 rounded-md px-10 py-5 bg-white/10 shadow-[0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[20px] flex flex-row items-center justify-between">
