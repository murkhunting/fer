...
export default function FooterSnap() {
  return (
    <footer className="w-screen h-screen snap-start relative">
      <div className="absolute bottom-0 w-full h-[50vh] bg-[rgba(247, 247, 247, 0)]/10 shadow-[0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[20px] flex flex-col items-center justify-between z-41 pt-6 pb-2 px-6">
        <div className="flex flex-col w-full h-[25vh] items-start justify-start">
