...
export default function Footer() {
  return (
    <footer className="relative w-screen h-[50vh] bg-[rgba(247, 247, 247, 0)]/10 shadow-[0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-[20px] flex flex-row items-star justify-center pt-6 pb-2 px-6">
